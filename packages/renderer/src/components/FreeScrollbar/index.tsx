      ...
      >
        <div
          ...
          style={{
            ...
            paddingRight: this.props.browserOffset,
            paddingBottom: this.props.browserOffset,
          }}
          // eslint-disable-next-line @typescript-eslint/ban-ts-comment
          // @ts-ignore
